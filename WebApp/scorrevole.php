						...
						<table class=cosa>
							<tr>
								<th class="intestazionedata">
									...
									<div class="menu">
										<ul>
											<li><a href="fermo.php" target="_blank" class="udienze">Fermo</a></li>
								...
								<th class="intestazionedata">
									<a href="https://www.istitutopilati.it" target="_blank">
										<img href="https://www.istitutopilati.it" target="_blank" src="Immagini/logoPilati1.png" alt="logoistituto" height="70" width="70" align="right" >
									</a>
								</th>
							</tr>
							<tr>
